...
public:
  ...
  static void         RenderAddon_SetCallbacks(void *addonData, GUIHANDLE handle, GUIHANDLE clienthandle, bool (*createCB)(GUIHANDLE,int,int,int,int), void (*renderCB)(GUIHANDLE), void (*stopCB)(GUIHANDLE));
...
protected:
  bool (*CBCreate) (GUIHANDLE cbhdl, int x, int y, int w, int h);
